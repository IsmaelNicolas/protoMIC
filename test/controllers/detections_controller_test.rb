...
class DetectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detection" do
    assert_difference("Detection.count") do
      post detections_url, params: { detection: { plague: @detection.plague, severity: @detection.severity } }
    end
  ...
  test "should update detection" do
    patch detection_url(@detection), params: { detection: { plague: @detection.plague, severity: @detection.severity } }
